...
import ProjectImg1 from "../assets/projects/hqdefault.jpg";
...
const ProjectData = [
  {
    ...
    image: ProjectImg1,
    previewLink: "https://amrtammam3.github.io/fitnees-project/",
  },
  {
...
function MyBook(props) {
  return (
    <HTMLFlipBook width={600} height={700} showCover="true">
      ...
      <Page number={8}>
        <Cover coverImg={EndImg} title="Thank you for reviewing my application I’m excited about the prospect of adding value and collaborating with a forward-thinking team like yours" />
      </Page>
    </HTMLFlipBook>
  );
}
